...
<!-- m-cd-top end -->
<!-- search start -->
<form class="webdesigntuts-workshop js-search search-form search-form--modal" method="get" action="/search" role="search">
	<div class="search-form__inner">
		<div>
			<p class="fa fa-hand-o-down fa-2x" aria-hidden="true"><font size="5" face="arial" color="black" font-weight="100" font-style="italic">输入后按回车搜索 ...</font></p>
			<i class="iconfont icon-search"></i>
			<input class="" type="search" name="keyword" placeholder="Search" required>
		</div>
	</div>
